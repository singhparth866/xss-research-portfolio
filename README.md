...
2. Determine the execution context.
3. Understand browser parsing behavior.
4. Develop a reliable proof-of-concept.
5. Analyze security impact.
6. Document secure remediation.
7. Generalize the underlying security principle.
